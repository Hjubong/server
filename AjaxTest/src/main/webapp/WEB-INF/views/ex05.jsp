...
<body>
	...
	<table class="vertical">
		...
		<tr>
			<th>주소</th>
			<td><input type="text" name="address" id="address" value="수원시 권선구"></td>
		</tr>
		<tr>
			<th>전화</th>
	...
	<script>
		...
		$('#btn').click(function(){
			...
			*/
			...
			//name=%ED%99%8D%EA%B8%B8%EB%8F%99&age=20&gender=m&address=%EC%88%98%EC%9B%90%EC%8B%9C+%EA%B6%8C%EC%84%A0%EA%B5%AC&tel=010-1234-1234
